...
<div id="fullscreen-menu-mobile" class=" hidden-lg-up initiallyHidden" style="width: 100vw; height: 100vh; background-color: black; z-index: 1030; position: fixed;">
	<div id="" class="fixed-top hidden-lg-up" style="background-color: black; width: 100%; height: 50px; display: flex; justify-content: space-between; align-items: center;  border-bottom: 1px solid black;">
	  <div class="">
	    <a href="/index.php">
	  ...
	  <div>
	  	<a class="" style="">
	        <i id="menu-mobile-close" class="fa fa-times topbar-icon" style="font-size: 30px; padding: 0 15px 0 3px; color: white;"></i>
	      </a>
	  </div>
	</div>

	<div id="mobile-menu-links" style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
	...
	<div class="" style="font-size: 40px; color: white; position: absolute; bottom: 15px; right: 15px; display: flex; flex-direction: row; flex-wrap: nowrap;">
