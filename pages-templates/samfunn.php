...
?>
   ...
   <div id="line-button" style="display: flex; white-space: nowrap; font-size: 50px; font-weight: 200; ">
    		<span><?php next_posts_link( 'MER SAMFUNNSTOFF', $arr_posts->max_num_pages ); ?></span>
    	</div>
