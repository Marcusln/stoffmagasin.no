...
<div id="om-oss-box" class=" hidden-md-down frontpage-margin bg-color-paper" style="position: relative; margin-bottom: 100px; padding: 25px;">
...
<div id="om-oss-box" class=" hidden-lg-up frontpage-margin bg-color-paper" style="position: relative; margin-bottom: 100px; margin-top: 50px; width: 100%; display: flex; flex-direction: row; flex-wrap: wrap;">

  <div class="" style="display: flex; flex-wrap:  wrap;">
    <div class="hidden-lg-up col-12 "  style="display: flex; flex-direction: column; text-align: left; font-family: 'Arapey', serif; font-size: 18px; line-height: 30px; font-weight: 400;">
      <p style="">Stoff magasin ble startet tidlig i 2015 av en gjeng NHH-studenter som ønsket å lage en unik, uavhengig og uredd studentavis. Første utgave ble lansert 20.03.15. Avisen satser på dyptgående, modig og kreativ journalistikk innenfor kultur, økonomi og samfunn. Stoff består av studenter som jobber frivillig og ulønnet som journalister, fotografer og grafikere. Redaksjonen har erfaring fra andre store aviser som blant annet Dagens Næringsliv, Bergens Tidende, Aftenposten og Finansavisen.</p>
      ...
      <div class=" " style="font-family: 'Arapey', serif; font-size: 18px; line-height: 30px; font-weight: 400;">
        <p>
          <b style="font-size: 26px;">Redaksjonen</b> <br />
        <b>Ansvarlig redaktør</b> Ingrid Marie Vikhammer Sandvik <br />
      ...
      <p style="text-align: left;">
        <b style="font-size: 26px;">Medieoppslag</b><br/>
        Dagens Næringsliv &mdash;<br/> <a class="underline" href="https://www.dn.no/etterBors/2015/03/10/2157/Medier/studentavisopprr-i-bergen" target="_blank">Studentavisopprør i Bergen</a><br /><br />

        Bergensavisen &mdash;<br/> <a class="underline" href="http://www.ba.no/Mener_NHHs_studentavis__Bulle__er_et_smiskeorgan-5-8-35800.html" target="_blank">Mener NHHs studentavis «Bulle» er et smiskeorgan</a><br /><br />

        Natt & Dag &mdash;<br/> <a class="underline" href="http://www.nattogdag.no/2015/03/stoff-magasin-pungshots-dekning-og-kvalitetsjournalistikk/" target="_blank">Pungshots-dekning og kvalitetsjournalistikk </a><br /><br />

        Inside &mdash;<br/> <a class="underline" href="http://www.inside24.no/k7-bulletin-og-studvest-har-fatt-ny-konkurrent/" target="_blank">K7 Bulletin og Studvest har fått ny konkurrent</a><br /><br />

        Studvest &mdash;<br/> <a class="underline" href="http://www.studvest.no/nytt-stoff-pa-markedet/" target="_blank">Nytt Stoff på markedet</a><br /><br />

        Studentradioen i Bergen &mdash;<br/> <a class="underline" href="http://srib.no/2015/03/24/nytt-stoff-pa-markedet/" target="_blank">Nytt Stoff på markedet</a><br /><br />

        Bergens Tidende &mdash;<br/> <a class="underline" href="http://www.bt.no/folk/Lager-avis-fra-hybelen-3328137.html?xtor=RSS-2" target="_blank">Lager avis fra hybelen</a><br />
      </p>
...
<div style="font-family: 'Ludacrys', serif; font-size: 26px; width: 90vw; margin: 0 auto; padding: 15px; text-align: center; color: white !important; background-color: black !important; ">Ønsker du å annonsere i Stoff? Ta kontakt på <a href="mailto:red@stoffmagasin.no" style="color: white !important; "> red@stoffmagasin.no</a></div>
...
<script>
  /*
$(function() {
    $('.om-oss-knapp').addClass('meny-this');
  });
